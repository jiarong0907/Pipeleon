...
control MyIngress(inout headers hdr,
    ...
    action tab2_act(bit<16> port) {
        hdr.tcp.srcPort = port;
        hdr.tcp.dstPort = hdr.migration.tabl1_data;
    }
